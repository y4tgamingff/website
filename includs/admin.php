...
<div class="input-group input-group-outline my-3">
       <lable class="lable-control mt-2"> date:</lable><input class="form-control ms-2" type="date" name="date">
</div>
      </div>
...
<li class="nav-item">
  <a class="nav-link text-white " href="pages/slider.php">
                ...
                if(mysqli_num_rows($arrey)>0){
                  ...
                  <td>
                    <div class="d-flex px-2 py-1">
                      ...
                      <div class="d-flex flex-column justify-content-center">
                        <h6 class="mb-0 text-sm"><?php echo  $row['no'];  ?></h6>
