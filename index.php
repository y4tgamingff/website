...
<div class="body-wrapper">
                ...
                <div class="row">
                    <div class="col">
                        <div class="site-logo-wrap" >
                            <div class="site-logo">
                                <a href="index.php"><img src="img/2.png" alt="Logo" height="70%" width="80%"></a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="header-menu d-none d-xl-block">
                            <nav>
                                <div class="ltn__main-menu">
                                    <ul>
                                        <li class="hover1"><a href="index.html">HOME</a>
                                        </li>
                                        <li class="hover1"><a href="about.html">ABOUT</a>
                                        </li>
                                        <li class="hover1"><a href="#">SHOP</a>
                                            <ul>
                                        ...
                                        <li class="hover1"><a href="#">PAGES</a>
                                            <ul class="mega-menu">
    ...
    <div class="ltn__product-tab-area ltn__product-gutter  pb-70">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="ltn__tab-menu ltn__tab-menu-2 ltn__tab-menu-top-right-- text-uppercase text-center">
                        <div class="nav">
                            <a class="active show" data-toggle="tab" href="#liton_tab_3_1">SPICES</a>
                            <a data-toggle="tab" href="#liton_tab_3_2" class="">BLENDED</a>
                            <a data-toggle="tab" href="#liton_tab_3_3" class="">INSTANT MIXES</a>
                            <a data-toggle="tab" href="#liton_tab_3_4" class="">GROCERIES</a>
                            <a data-toggle="tab" href="#liton_tab_3_5" class="">OTHER ITEMS</a>
                        </div>
                    </div>
                                            ...
                                            <div class="product-img">
                                                ...
                                                <div class="product-hover-action">
                                                    <ul>
                                                        <li>
                                                            <a href="#" title="Quick View" data-toggle="modal" data-target="#quick_view_modal">
                                                                <i class="far fa-eye fao"></i>
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a href="#" title="Add to Cart" data-toggle="modal" data-target="#add_to_cart_modal">
                                                                <i class="fas fa-shopping-cart fao"></i>
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a href="#" title="Wishlist" data-toggle="modal" data-target="#liton_wishlist_modal">
                            ...
                            <div class="ltn__product-tab-content-inner">
                                <div class="row ltn__tab-product-slider-one-active slick-arrow-1">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="ltn__product-item ltn__product-item-3 text-center">
                                            <div class="product-img">
                                                <a href="product-details.html"><img src="img/product/3128112043.jpg" alt="#"></a>
                                                <div class="product-badge">
                                                    <ul>
                                                        <li class="sale-badge">-19%</li>
                                                    </ul>
            ...
            <div class="row">
                ...
                <div class="col-lg-7">
                    <div class="call-to-action-inner call-to-action-inner-4 text-color-white--- text-center---">
                        ...
                        <div class="ltn__countdown ltn__countdown-3 bg-white--" data-countdown="20/12/28"></div>
                        <div class="btn-wrapper animated">
                    ...
                    <div class="col-xl-3 col-md-6 col-sm-6 col-12">
                        <div class="footer-widget footer-about-widget">
                            <div class="footer-logo">
                                <div class="site-logo">
                                    <img src="img/2.png" alt="Logo"  height="60px" width="150px">
                                </div>
                            </div>
